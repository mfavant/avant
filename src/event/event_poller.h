...
namespace avant::event
{
        ...
        public:
                 ...
                 * @param et
                 */
                int add(int fd, uint32_t events, bool et = false);
                 ...
                 * @param events same as add()
                 * @param et
                 */
                int mod(int fd, uint32_t events, bool et = false);
        ...
        private:
                 ...
                 * @param et
                 */
                int ctrl(int fd, uint32_t events, int op, bool et = false);
#endif
        private:
                /**
                 * @brief epoll句柄
